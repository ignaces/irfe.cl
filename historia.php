...
<head>
    <title><?php echo "$maintitle" ?> | <?php echo "$beta4" ?></title>
...
<!-- CONTENIDO -->
<div id="contenido" style="position:relative;top:10px;margin:0 auto;width:980px;height:inherit;background:url('static/img/bg_presentador.png') repeat;"><!--contenidoneto--><h1><?php echo "$beta4 del $irfe" ?></h1><div id="texto"><?php include'static/data/articulos.php';echo"$contenido_1";?></div></div><!--/end--></div>
<!-- /contenido -->
<!--ultimotweetglobal-->
